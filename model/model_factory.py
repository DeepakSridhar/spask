...
from model.deeplab_2branch_unsupkeypoints import Res50_Deeplab_2branch_Geometric, Res101_Deeplab_2branch_Geometric
...
def model_generator(args):
    ...
    if args.model == 'DeepLab':
        ...
        if args.restore_from is None:
            args.restore_from = PRETRAINED_MODEL['resnet-50-caffe']
    elif args.model == 'DeepLab50_2branch_Geometric':
        model = Res50_Deeplab_2branch_Geometric(args, num_classes=args.num_parts+1)
        if args.restore_from is None:
            args.restore_from = PRETRAINED_MODEL['resnet-50-caffe']
    else:
